...
[Adapter](http://yywang.info/2014/07/26/adapter/)：将一个类的接口转换成客户希望的另外一个接口。Adapter模式使得原本接口不兼容。而不能一起工作的类，可以一起工作。
...
[Singleton](http://yywang.info/2014/07/12/singleton/)：保证一个类仅有一个实例，并且提供它的全局访问点。
